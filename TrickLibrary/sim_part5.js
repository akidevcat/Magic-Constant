...
var main = function() { 
	...
	//print(script.readAll('C:/Users/wolfn/Desktop/input.txt').toString());
	...
	var code = artag_obj.get_code(script.readAll('input.txt').toString());

	var target = [parseInt(code[0]), parseInt(code[1])]
	...
	movementlib.move_path(70, path, 8, 8, irLeftSensor, irRightSensor, uzFrontSensor, 1.2, 0.5, 0);
...
movementlib.correctionthreshold = length / 1.75; //for sim
