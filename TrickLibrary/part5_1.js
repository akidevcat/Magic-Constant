...
var scantag = function(ang) {
	...
	while(code[0] == -1)
	{
		...
		if (ang > 0)
			movementlib.rotate_encoderssmooth(3, -pi / 80);
		else
			movementlib.rotate_encoderssmooth(3, pi / 80);
		script.wait(10);
		i++;
...
var main = function() {
	...
	movementlib.move_pathcorrection(70, path, 8, 8, irLeftSensor, irRightSensor, uzFrontSensor, 1.4, 0.85, 0);
	...
	if (delta_angle > 0)
		...
		movementlib.rotate_encoderssmooth(30, - pi / 2 * 0.6);
	else {
		//movementlib.rotate_absolute(20, rot2teta(arrot));
		movementlib.rotate_encoderssmooth(30, pi / 2 * 0.6);
	}
